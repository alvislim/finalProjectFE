          ...
          <Container>
            <div className='d-flex justify-content-center mt-5 mb-3'>
              ...
              <Card>
                <ListGroup className='list-group-flush'>
                  ...
                  <ListGroupItem>
                    <h6>Desired Price:</h6>${userItem.price}
                  </ListGroupItem>
                  <ListGroupItem>
                    <h6>Product Current Price:</h6> ${userItem.desiredPrice}
                  </ListGroupItem>
                </ListGroup>
              </Card>
            </div>
            ...
            {relevantItems.length === 1 ? (
              <Container
                ...
                style={{ height: "100vh" }}>
                <Card.Subtitle>
                  We are unable to retrieve any results from{" "}
              ...
              <div>
                <h6>
                  Below data is fetched from Sheng Shiong with the key word '
                  {userItem.name}'
                </h6>
                <span>
                  <h6>
                    Alternatively, you can visit Sheng Shiong{" "}
                    <a href='https://www.allforyou.sg/'>here</a>
                  </h6>
                </span>
                <ToolkitProvider
                  keyField='name'
                  ...
                  {(props) => (
                    <div className='mb-5'>
                      <SearchBar
                        {...props.searchProps}
                        placeholder='Search the products fetched from Sheng Shiong'
                      />
                      <BootstrapTable
                        {...props.baseProps}
